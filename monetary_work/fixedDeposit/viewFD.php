        ...
        <div class="fund-transfer-box">
            ...
            <form action="#">
                ...
                <div class="input-box">
                    ...
                    <input type="number" id="interest" name="receiver-bank-account" value="<?= $row["interest"] ?>" readonly>
                </div>
                
                <div class="input-box">
                    <label for="created-date">Creation Date</label>
                    <input type="date" id="created-date" name="receiver-bank-account" value="<?= $row["date_created"] ?>" readonly>
                </div>

                <div class="input-box">
                    <label for="maturity-date">Maturity Date</label>
                    <input type="date" id="maturity-date" name="receiver-bank-account" value="<?= $row["date_matured"] ?>" readonly>
                </div>
